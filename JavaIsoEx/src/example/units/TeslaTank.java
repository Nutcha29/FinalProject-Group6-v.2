 ...
 * @author Wouter
 */
public class TeslaTank extends Moveable {
   ...
   * @see Moveable
   */
  public TeslaTank(DoublePoint pixelLocation, int speed, MoveableTextureCollection textures) {
    this.setPixelLocation(pixelLocation);
    this.setSquare(EngineWindow.getInstance().getGame().getPlayfieldGrid().translatePixelToSquare(pixelLocation.toPoint()));
    this.setSpeed(speed);
  ...
  public String toString() {
    return "TeslaTank @ ( " + this.getSquare() + " )";
  }
